...
Widget getProfileImage(AccountController controller, String loginWith) {
  if (controller.isPhoto.value == "") {
    ...
    return ShowImage(
        imageUrl: loginWith != "google"
            ? getLink(controller.userData.value.uPhoto)
            : controller.userData.value.uPhoto);
  }
  return Image.asset("lib/assets/images/user.png");
}
